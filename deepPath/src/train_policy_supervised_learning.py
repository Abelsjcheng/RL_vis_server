...
from deepPath.src.networks import PolicyNN
...
def train_deep_path():
    ...
    torch.save(policy_network.state_dict(), os.path.join(model_dir, model_name + relation + '.pt'))
